...
export const locales = {
  zh: {
    ...
    fieldJobs: {
      ...
      formEmployeeHint: "已请假、与已有外勤单时间重叠或间隔不足1小时的员工不会显示；选择后工单状态为已分配",
      assignTitle: "分配外勤工单",
      assignConfirm: "确认分配",
  ...
  en: {
    ...
    fieldJobs: {
      ...
      formEmployeeHint: "Employees on leave or with overlapping/nearby field jobs (<1h gap) are hidden. Selecting one sets the job to Assigned.",

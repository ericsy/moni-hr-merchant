...
export const locales = {
  zh: {
    ...
    fieldJobs: {
      ...
      locateOnMap: "定位",
      addressLocateHint: "填写地址后点击「定位」，在地图上确认打卡围栏；可拖动标记微调。",
  ...
  en: {
    ...
    fieldJobs: {
      ...
      locateOnMap: "Locate",
      addressLocateHint: "Enter the address and tap Locate to set the punch geofence. Drag the marker to fine-tune.",
